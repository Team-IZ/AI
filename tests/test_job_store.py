...
def test_get_missing_job_returns_none(dynamodb_tables):
    store = DynamoDbJobStore(AnalysisJobStatus, JOBS_TABLE, IDEM_TABLE, "ap-northeast-1")
...
def test_write_from_one_instance_is_visible_from_another(dynamodb_tables):
    ...
    task_a_store = DynamoDbJobStore(AnalysisJobStatus, JOBS_TABLE, IDEM_TABLE, "ap-northeast-1")
    task_b_store = DynamoDbJobStore(AnalysisJobStatus, JOBS_TABLE, IDEM_TABLE, "ap-northeast-1")
...
def test_ttl_attribute_is_set_on_write(dynamodb_tables):
    ...
    store = DynamoDbJobStore(AnalysisJobStatus, JOBS_TABLE, IDEM_TABLE, "ap-northeast-1", ttl_days=7)
